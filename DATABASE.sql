...
create table customer(document varchar(20), number varchar(30), name varchar(20), gender varchar(15), country varchar(20), room varchar(10),checkintime varchar(80), deposit varchar(20));
...
insert into department values('Food and Beverage','200000');
insert into department values('Kitchen','550000');
